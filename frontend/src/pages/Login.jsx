        ...
        <div className={`rounded-2xl border backdrop-blur-xl shadow-xl p-8 ${darkMode ? 'border-gray-700 bg-dark-800/80 shadow-black/20' : 'border-gray-200 bg-white/80 shadow-gray-200/50'}`}>
          ...
          <div>
            <button
              ...
              className={`flex items-center justify-center gap-2 w-full py-2.5 rounded-xl border text-sm font-medium transition-colors duration-200 cursor-pointer ${darkMode ? 'border-gray-600 text-gray-300 hover:bg-gray-700' : 'border-gray-200 text-gray-700 hover:bg-gray-50'}`}
            >
